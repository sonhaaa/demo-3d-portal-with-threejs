 ...
 * Textures
 */
const backedTexture = textureLoader.load(
    'myModels/baked.jpg'
)
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        const poleLightBMesh = gltf.scene.children.find((child) => child.name === 'Cube015')
...
window.addEventListener('resize', () =>
{
    ...
    // Update fireflies
    fireflies.uniforms.uPixelRatio = Math.min(window.devicePixelRatio, 2)
})
